...
export class News extends Component {
  ...
  constructor(props) {
    ...
    document.title=`${this.capitalizaFirstLatter(this.props.category)}- NewsMonkey`;
  }
  async UpdateNews() {
    console.log("UpdateNewscmd");
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=57e1aed4cbb946be91d242fc02bf1400&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  render() {
    ...
    return (
      <div className="container my-3">
        ...
        NewsMonkey - Top  {this.capitalizaFirstLatter(this.props.category)}Headlines
        </h1>
